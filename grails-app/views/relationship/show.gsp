...
<html>
    ...
    <body>
        ...
        <div id="show-relationship" class="content scaffold-show" role="main">
            ...
            <f:display bean="relationship" />
            </ol>
            <g:form resource="${relationship}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${relationship}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
