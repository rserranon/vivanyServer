...
<html>
    ...
    <body>
        ...
        <div id="show-entry" class="content scaffold-show" role="main">
            ...
            <f:display bean="entry" />
            </ol>
            <g:form resource="${entry}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${entry}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
