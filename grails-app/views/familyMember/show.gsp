...
<html>
    ...
    <body>
        ...
        <div id="show-familyMember" class="content scaffold-show" role="main">
            ...
            <f:display bean="familyMember" />
            </ol>
            <g:form resource="${familyMember}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${familyMember}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
