...
<html>
    ...
    <body>
        ...
        <div id="show-family" class="content scaffold-show" role="main">
            ...
            <f:display bean="family" />
            </ol>
            <g:form resource="${family}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${family}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
