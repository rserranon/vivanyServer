...
<html>
    ...
    <body>
        ...
        <div id="show-treatment" class="content scaffold-show" role="main">
            ...
            <f:display bean="treatment" />
            </ol>
            <g:form resource="${treatment}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${treatment}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
